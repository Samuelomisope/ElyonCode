...
const features = [
    {
        ...
        description: "Intelligent code suggestion using AI that learns from your coding patterns. Get real-time assistance with syntax, logic, and best practices.",
        codeSnippet: `function handleSubmit(){
        //AI suggests next line code
...
},
 {
        ...
        description: "Generate comprehensive test suites automatically. Our AI analyzes your code and create unit tests, integration tests, and edge case coverage.",
                ...
                {features.map((feature, key) => (
                    <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition === "right" ? "lg:flex-row-reverse" : "" }`}>
                        ...
                        <div className="flex-1 w-full">
                            ...
                            ded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border-1
                            p-hover:border-blue-600/50 transition-all duration-300">
                                {/* IDE Interface */}
                                <div className="bg-gray-950 rounded-lg p-3 sm:p-4 font-mono text-xs sm:text-small">
                                    <div className="flex items-conter space-x-1 sm:space-x-2 mb-3 sm:mb-4">
