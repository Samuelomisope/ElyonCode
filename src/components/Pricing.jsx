import { Check, PrinterCheck, Star } from "lucide-react"
    ...
    return(
        ...
        >
            ...
            <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                ...
                <p className="text-gray-400 text-base text-xl sm:text-lg max-ww-2xl mx-auto">
                    Choose the perfect plan for your need. All plans iclude a 7-days free trial.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
                {plans.map((plan, key) => (

                    <div key={key} className={`relative bg-slate-900/50 backdrop-blur-sm border ronded-xl sm:rounded-2xl p-6 sm:p-8 transition-alll duration-300 overflow-visible group flex flex-col h-full ${plan.mostPopular ? "border-blue-500 shadow-2xl shadow-blue-500/20 lg:scale-105" : 
                        "border-slate-800 hover:border-slate-700"}`}>
                            ...
                            <div className="text-center mb-6 sm:mb-8">
                                ...
                                <div className="flex item-baseline justify-center">
                            ...
                            <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row">
                                {plan.features.map((feature, featurekey) => (
                                    <li key={featurekey} className="flex items-start space-x-2 sm:space-x-3">
                                        <div className="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-blue-500/20 flex item-center justify-center mt-0.5">
